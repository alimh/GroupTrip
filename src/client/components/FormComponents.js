...
export const SelectBox = (props) => (!props.disabled
  ? (
    <Form.Group>
        ...
        ? (
          <CheckboxElement
            ...
            onUpdate={() => {
              ...
              props.options.forEach((n, i) => {
                newOptions[i].checked = !currentStatus;
                return false;
              });
...
export class FormBuilder extends React.Component {
  ...
  resetForm() {
    this.setState((prevState) => ({
      values: prevState.initial.values,
      errors: prevState.initial.errors,
      dirty: false,
    }));
  }
  ...
  handleUpdate(field, value) {
    ...
    this.setState((prevState) => {
      const errors = {
        ...prevState.errors,
        [field]: prevState.errorChecks[field](value),
      };
      const values = {
        ...prevState.values,
        [field]: value,
      };
      return { values, errors, dirty: true };
    });
  }
  ...
  handleSave(e) {
    ...
    const confirmPasswordCheck = this.state.values.confirm_password !== undefined
  ...
  render() {
    ...
    const confirmRemoveButtonText = this.props.confirmRemoveButtonText || 'Confirm';
